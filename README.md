...
ความโปร่งใสและปลอดภัยของระบบบล็อคเชนจะเข้ามามีบทบาทกับวิธีทำงานและกระบวนการทุกอย่างในโลกดิจิตอลในไม่ช้า [คลิปวีดีโออธิบาย Blockchain#2](https://www.youtube.com/watch?v=NTNQMKB0A3A)

### การเข้ารหัสแฮช
[การเข้ารหัสแฮช](https://www.youtube.com/watch?v=KyUTuwz_b7Q&t=697s) เป็นวิธีเรียงลำดับข้อมูล(data structure)แบบหนึ่ง แต่ด้วยคุณสมบัติพิเศษของผลลัพภ์แฮช ทำให้มันถูกนำมาใช้ในการ [รักษารหัสผ่าน Password & hash functions](https://www.youtube.com/watch?v=cczlpiiu42M) รวมถึงใช้เทียบข้อมูลระหว่าง node ในบล็อคเชนอีกด้วย
