...
โดยทั่วไปแล้วการ fork จะเกิดขึ้นเมื่อนักพัฒนาเห็นตรงกันว่าระบบควรอัพเดทเพื่อให้มีประสิทธิภาพดีขึ้น เมื่อระบบมีการเปลี่ยนแปลง คนขุดเหรียญ(คนต่อบล็อค)ก็จำเป็นต้องแก้ไขระบบตามเพื่อให้ตรงกันกับระบบปัจจุบัน ถ้าคนขุดเหรียญไม่แก้ไขตามระบบหลัก บล็อคที่ขุดได้ก็จะแยกออก(fork)เป็นคนละเชนกันกับบล็อคเชนปัจจุบัน [Blockchain Forks Explained](https://medium.com/digitalassetresearch/blockchain-forks-explained-8ccf304b97c8)
